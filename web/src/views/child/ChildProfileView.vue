<template>
  <section class="panel">
    <h3 class="section-title">子女资料</h3>
    ...
    <div v-else class="form-grid">
      ...
      <div class="field"><label>与老人关系</label><input v-model="form.relation" /></div>
      <div class="field field-full"><label>备注</label><textarea v-model="form.note" /></div>
    </div>
